...
'.$lang['confirm_order_mail_link'].':<br /><a href="http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?confirm='.$id.'" style="color:#FF4D00;">http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?confirm='.$id.'</a>
</td>
</tr>';	
}
} //payment
...
<td style="text-align:left; padding:1px 3.5px 1px 3.5px;"><a href="http://'.$host_name.'" style="color:'.$color1.';">www.'.$host_name.'</a></td>
</tr>';
$mess .= '</table>
