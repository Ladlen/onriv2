...
if (isset($_GET['reservation'])) {
    $ofadm_url = '&amp;reservation';
    $ofadm_url_alt = '?reservation';
} else if (isset($_GET['edit'])) {
    $ofadm_url = '&amp;edit=' . $_GET['edit'];
    $ofadm_url_alt = '?edit=' . $_GET['edit'];
} else {
    $ofadm_url = '';
    $ofadm_url_alt = '';
}
...
if (file_exists($file_config)) { // keep config file 
    ...
    if ($cmod_file_config != '0644') {
        chmod($file_config, 0644);
    }
...
//---Lang
if (!isset($language)) {
    include($folder . $psep . 'lang/ru_RU.php');
} else {

    if (file_exists($folder . $psep . 'lang/' . $language)) {
        include($folder . $psep . 'lang/' . $language);
    } else {
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $folder . $psep; ?>css/main.css?ver=<?php echo date('m.y'); ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo $folder . $psep; ?>css/colorbox.css?ver=<?php echo date('m.y'); ?>"/>


    <!-- MOBILE STYLE -->
    <?php $ag_detect = new Ag_Mobile_Detect;
    if ($ag_detect->isMobile()) { ?>
        <link rel="stylesheet" type="text/css"
              href="<?php echo $folder . $psep; ?>css/mob.css?ver=<?php echo date('m.y'); ?>"/>
        <style>
...
<![endif]-->
    ...
    <!--[if lte IE 8]>
    <link href="<?php echo $folder.$psep; ?>css/ie.css?ver=<?php echo date('d.m'); ?>"
...
//dark			
            ...
            <style>
                ...
                #cat_menu nav a.this_menu {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .title_serv h4 a:hover span {
                    color: <?php echo $color2; ?>;
                }

                #ag_main a.fbutton:hover, #ag_main a.fbutton:focus {
                    background: <?php echo $color2; ?>;
                }

                #ag_main .serv:hover div.desc_serv {
                    background: <?php echo $light_color1; ?>;
                }

                #ag_main .serv_block {
                    border-bottom: <?php echo $color1; ?> 2px solid;
                }

                #ag_main .title_full_serv a {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .title_full_serv a:hover {
                    background: <?php echo $color2; ?>;
                }

                #ag_main .title_full_serv span.ugol {
                    border-right: <?php echo $color1; ?> 15px solid;
                }

                #ag_main .back:hover a {
                    background: <?php echo $color2; ?>;
                }

                #ag_main .back:hover span {
                    border-right: <?php echo $color2; ?> 15px solid;
                }

                #ag_main .tools_calendar a {
                    color: <?php echo $color1; ?>;
                }

                #ag_main .tools_calendar a:hover {
                    color: <?php echo $color2; ?>;
                }

                #ag_main .select_cal a, #ag_main .select_cal button {
                    color: <?php echo $color1; ?> !important;
                }

                #ag_main .select_cal button:hover, #ag_main .select_cal a:hover {
                    color: <?php echo $color2; ?> !important;
                }

                #ag_main .staff_time span.staff_list_time a {
                    border-bottom: 1px dashed <?php echo $color1; ?>
                }

                #ag_main .staff_time span.staff_list_time a:hover {
                    border-bottom: 1px dashed <?php echo $color2; ?>
                }

                #ag_main #p_info span.t_curr, span.t_curr {
                    color: <?php echo $color1; ?> !important;
                }

                #ag_main #p_info span.t_curr i, span.t_curr i {
                    color: <?php echo $color1; ?> !important;
                }

                #ag_main #p_info span.p_block span.currleft i {
                    color: <?php echo $color1; ?> !important;
                }

                #ag_main #p_info span.p_block span.currright i {
                    color: <?php echo $color1; ?> !important;
                }

                #ag_main .in_spots div.clicker span:hover {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .in_spots div.desc_spots a {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .in_spots div.desc_spots a:hover {
                    background: <?php echo $color2; ?>;
                }

                #ag_main .in_focus:before {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .discount_str span {
                    background: <?php echo $color1; ?>;
                }

                #cboxClose, .close_window_iframe {
                    color: <?php echo $color1; ?> !important;
                }

                #cboxClose:hover, .close_window_iframe:hover {
                    color: #fff !important;
                    background: <?php echo $color1; ?>;
                }
                ...
                #ag_main .print_order div.bot_order a {
                    background: <?php echo $color1; ?>;
                }

                #ag_main .print_order div.bot_order a:hover {
                    background: <?php echo $color2; ?> !important;
                }

                #ag_main .mess_back a:hover {
                    background: <?php echo $color1; ?>;
                }

                #ag_main button, input[type="button"], #ag_main input[type="submit"], #ag_main a.abutton {
                    color: #fff;
                }

                #ag_main .select_cal button, #ag_main .select_cal button:hover {
                    background: #fff;
                }

                #ag_payment_modules div.payment_item label div:hover {
                    background: <?php echo $light_color1; ?>;
                }

                #open_payment label:hover h5 {
                    color: <?php echo $color2; ?> !important;
                    border-bottom: 1px dashed <?php echo $color2; ?>;
                }
    ...
    <script>
        $(document).ready(function () {
            ...
            setTimeout(function () {
                ctn.setAttribute("style", "visibility:visible; opacity:1;");
            }, 40);
        });
    </script>
    <noscript>
...
$mr = '12345';
//======================================================/TEMP
include_once ($folder.$psep.'inc/orders_process.php');
//====================================order cleaner
/////////////////////////////////////////
/////////////////////////////////////////
...
echo '<div class="shadow_back"><div class="error">'.$lang['error'].'<div class="mess_back"><a href="index.php">'.$lang['close'].'</a><div class="clear"></div></div></div></div>
